...
public final class QueryUtils {
    ...
    /**
     * Query the USGS dataset and return a list of {@link NewsEvent} objects.
     */
    public static List<NewsEvent> fetchEarthquakeData(String requestUrl) {
        ...
        // Extract relevant fields from the JSON response and create a list of {@link NewsEvent}s
    ...
    /**
     * Return a list of {@link NewsEvent} objects that has been built up from
    ...
    private static List<NewsEvent> extractFeatureFromJson(String newsJSON) {
        ...
        // Create an empty ArrayList that we can start adding newsEvents to
        ...
        try {
            ...
            // which represents a list of features (or newsEvents).
            JSONObject responseObject = baseJsonResponse.getJSONObject("response");

            JSONArray results = responseObject.getJSONArray("results");
            // For each earthquake in the responseObject, create an {@link NewsEvent} object
